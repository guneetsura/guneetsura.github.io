...
const Substack: React.FC<{ size?: number }> = ({ size = 20 }) => <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22.539 8.242H1.46V5.406h21.08v2.836zM1.46 10.812V24L12 18.11 22.54 24V10.812H1.46zM22.54 0H1.46v2.836h21.08V0z"/></svg>;
  ...
  return <section id="home" className="hero-shell relative min-h-screen flex items-center overflow-hidden">
    ...
    <div className="section !py-0 w-full relative z-10">
      ...
      <motion.div custom={reveal(0.5)} initial="hidden" animate="visible" variants={fadeUp} className="mt-12 flex items-center gap-5">
        ...
        <a href="https://guneetsura.substack.com" target="_blank" rel="noopener noreferrer" className="text-[var(--text-faint)] hover:text-[var(--text)] transition-colors" aria-label="Substack"><Substack size={20} /></a>
      </motion.div>
    </div>
