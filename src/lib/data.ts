...
export const portfolioData: PortfolioData = {
  profile: {
    ...
    tagline:
      "Frontend-focused software engineer building production-ready web experiences with React, Next.js, and TypeScript — attentive to performance, responsive interfaces, and a polished user experience, with full-stack range to ship a product end to end.",
  ...
  projects: [
     ...
     },
    {
      ...
      title: 'FinDash',
      description:
        'A premium "Zen-Futuristic" financial dashboard and transaction registry with a glass-morphic aesthetic. Features real-time analytics, paginated transaction ledger with multi-conditional filtering, role-based workflows (Admin/Viewer), and CSV export — all persisted via LocalStorage.',
      technologies: ['Next.js 16', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Recharts', 'React Context API'],
      github: '#',
      live: 'https://findash-blush-theta.vercel.app/dashboard',
      featured: true,
    },
    {
      id: 'dark-web-crawler',
      ...
      github: '#',
      live: 'https://www.somaiya.edu/en/view-announcement/444/',
      featured: true,
    ...
    },
    {
      ...
      github: '#',
      live: 'https://short-en-it.vercel.app/',
      featured: false,
    },
  ],
